<template>
  <div v-if="showToolbar" class="gantt-toolbar">
    <div class="toolbar-left">
      <MdGanttToolsFilterButton :available-columns="availableColumns" @filter-change="handleFilterChange" />
      <MdGanttToolsSortButton :available-columns="availableColumns" @sort-change="handleSortChange" />
