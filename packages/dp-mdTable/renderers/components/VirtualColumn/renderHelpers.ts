 ...
 */
export function renderAsSingleSelect(
  values: any[],
  targetConfig: TargetFieldConfig,
  separator: string = ', '
): ReturnType<typeof h> {
 ...
 */
export function renderAsMultiSelect(
  values: any[],
  targetConfig: TargetFieldConfig,
  separator: string = ', '
): ReturnType<typeof h> {
 ...
 */
export function renderAsNumber(
  values: any[],
  targetConfig: TargetFieldConfig,
  separator: string = ', '
): ReturnType<typeof h> {
 ...
 */
export function renderAsDateTime(
  values: any[],
  targetConfig: TargetFieldConfig,
  separator: string = ', '
): ReturnType<typeof h> {
 ...
 */
export function renderAsCheckbox(
  values: any[],
  separator: string = ', '
): ReturnType<typeof h> {
  if (values.length === 0) {
 ...
 */
export function renderAsRating(
  values: any[],
  targetConfig: TargetFieldConfig,
  separator: string = ', '
): ReturnType<typeof h> {
