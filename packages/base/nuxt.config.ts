...
const config = {
  ...
  modules: ['@nuxtjs/i18n', '@nuxtjs/color-mode', '@vueuse/nuxt'],
  css: ['../assets/styles/main.scss'],
  extends: ['../sql-store', '../inline-ocr'],
  ...
  nitro: {
    ...
    devProxy: {
      ...
      '/gateway': {
        target: process.env.DOCPAL_GATEWAY_PROXY_V1 || process.env.DOCPAL_GATEWAY_PROXY + '/v1/ucenter',
        changeOrigin: true,
        prependPath: true,
        headers: {
          'accept-encoding': 'identity'
