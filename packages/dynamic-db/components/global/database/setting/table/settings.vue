...
const { databaseMenuRouteParams, deleteItem } = useSingleDatabaseContext()

async function handleDeleteTable() {
  if (!databaseMenuRouteParams.value.detailId) return
  ...
  try {
    ...
    await deleteItem(databaseMenuRouteParams.value.detailId)
