...
const { tableConfig, tableEvent, tableRef, reload } = useVxeTable({
  ...
  api: (pageParams: any) => {
    return newAdminApi.getAdmindmsCalendarsEventSettings({ eventCalendarSetting: {} })
  },
  virtualScroll: true,
  pageSize: 5,
  columns: [
    ...
    [{
    ...
    },
      {
        ...
        action: async ({ row }: any) => {
          await newAdminApi.deleteAdmindmsMasterTableIdRecord(setting.value.category.master_table, { recordId: row.id }, {})
